...
Uses AMP + GradScaler (matching LaBraM's training setup) so that
occasional inf/NaN gradients are automatically skipped rather than
corrupting the model — this was the missing safety net in the first
version of this script, which diverged at epoch 2.
"""
import os
import sys
import json
...
def main():
    ...
    # Sampled estimate of class imbalance, capped to avoid destabilizing loss
